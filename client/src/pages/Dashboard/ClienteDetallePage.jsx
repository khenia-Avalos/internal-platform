    ...
    <div className="px-4 md:px-6 py-4 md:py-6 max-w-full">
      ...
      {!loading && cliente && (
        <>
          ...
          {/* CARD 2: Mascotas e Historial de Citas */}
          <div className="mt-6">
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
              ...
              <div className="bg-gray-100 px-6 py-4 border-b border-gray-200 flex flex-wrap items-center justify-between gap-4">
                <h2 className="text-xl font-semibold text-gray-800">Mascotas e Historial de Citas</h2>
                <button 
                  onClick={() => {
                    setErrors([]);
              ...
              <div className="p-6">
                {/* seccion: mascotas */}
                <div>
                  <h3 className="text-lg font-semibold text-gray-800 mb-4">Mascotas de {cliente.username}</h3>
                  {mascotas.length === 0 ? (
