...
var error = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `مدخلات غير مقبولة: يفترض إدخال ${issue.expected}، ولكن تم إدخال ${parsedType8(issue.input)}`;
      case "invalid_value":
...
var error2 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Yanlış dəyər: gözlənilən ${issue.expected}, daxil olan ${parsedType8(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error3 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Няправільны ўвод: чакаўся ${issue.expected}, атрымана ${parsedType8(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error5 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Tipus invàlid: s'esperava ${issue.expected}, s'ha rebut ${parsedType8(issue.input)}`;
...
var error6 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Neplatný vstup: očekáváno ${issue.expected}, obdrženo ${parsedType8(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error7 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Ugyldigt input: forventede ${getTypeName(issue.expected)}, fik ${getTypeName(parsedType8(issue.input))}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error8 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Ungültige Eingabe: erwartet ${issue.expected}, erhalten ${parsedType8(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error9 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Invalid input: expected ${issue.expected}, received ${parsedType2(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error10 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Nevalida enigo: atendiĝis ${issue.expected}, riceviĝis ${parsedType3(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error11 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Entrada inválida: se esperaba ${getTypeName(issue.expected)}, recibido ${getTypeName(parsedType8(issue.input))}`;
...
var error12 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `ورودی نامعتبر: می‌بایست ${issue.expected} می‌بود، ${parsedType8(issue.input)} دریافت شد`;
      case "invalid_value":
        if (issue.values.length === 1) {
...
var error13 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Virheellinen tyyppi: odotettiin ${issue.expected}, oli ${parsedType8(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error14 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Entrée invalide : ${issue.expected} attendu, ${parsedType8(issue.input)} reçu`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error15 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Entrée invalide : attendu ${issue.expected}, reçu ${parsedType8(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error16 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `קלט לא תקין: צריך ${issue.expected}, התקבל ${parsedType8(issue.input)}`;
...
var error17 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Érvénytelen bemenet: a várt érték ${issue.expected}, a kapott érték ${parsedType8(issue.input)}`;
      // return `Invalid input: expected ${issue.expected}, received ${util.getParsedType(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error18 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Input tidak valid: diharapkan ${issue.expected}, diterima ${parsedType8(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error19 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Rangt gildi: Þú slóst inn ${parsedType4(issue.input)} þar sem á að vera ${issue.expected}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error20 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Input non valido: atteso ${issue.expected}, ricevuto ${parsedType8(issue.input)}`;
...
var error21 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `無効な入力: ${issue.expected}が期待されましたが、${parsedType8(issue.input)}が入力されました`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error22 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `არასწორი შეყვანა: მოსალოდნელი ${issue.expected}, მიღებული ${parsedType5(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error23 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `ទិន្នន័យបញ្ចូលមិនត្រឹមត្រូវ៖ ត្រូវការ ${issue.expected} ប៉ុន្តែទទួលបាន ${parsedType8(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error24 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `잘못된 입력: 예상 타입은 ${issue.expected}, 받은 타입은 ${parsedType8(issue.input)}입니다`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error25 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Gautas tipas ${parsedType6(issue.input)}, o tikėtasi - ${parsedTypeFromType(issue.expected)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error26 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Грешен внес: се очекува ${issue.expected}, примено ${parsedType8(issue.input)}`;
      // return `Invalid input: expected ${issue.expected}, received ${util.getParsedType(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
          return `Invalid input: expected ${stringifyPrimitive(issue.values[0])}`;
...
var error27 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Input tidak sah: dijangka ${issue.expected}, diterima ${parsedType8(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error28 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Ongeldige invoer: verwacht ${issue.expected}, ontving ${parsedType8(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error29 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Ugyldig input: forventet ${issue.expected}, fikk ${parsedType8(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error30 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Fâsit giren: umulan ${issue.expected}, alınan ${parsedType8(issue.input)}`;
...
var error31 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `ناسم ورودي: باید ${issue.expected} وای, مګر ${parsedType8(issue.input)} ترلاسه شو`;
      case "invalid_value":
        if (issue.values.length === 1) {
...
var error32 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Nieprawidłowe dane wejściowe: oczekiwano ${issue.expected}, otrzymano ${parsedType8(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error33 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Tipo inválido: esperado ${issue.expected}, recebido ${parsedType8(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error34 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Неверный ввод: ожидалось ${issue.expected}, получено ${parsedType8(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error35 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Neveljaven vnos: pričakovano ${issue.expected}, prejeto ${parsedType8(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error36 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Ogiltig inmatning: förväntat ${issue.expected}, fick ${parsedType8(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error37 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `தவறான உள்ளீடு: எதிர்பார்க்கப்பட்டது ${issue.expected}, பெறப்பட்டது ${parsedType8(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error38 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `ประเภทข้อมูลไม่ถูกต้อง: ควรเป็น ${issue.expected} แต่ได้รับ ${parsedType8(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error39 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Geçersiz değer: beklenen ${issue.expected}, alınan ${parsedType7(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error40 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Неправильні вхідні дані: очікується ${issue.expected}, отримано ${parsedType8(issue.input)}`;
...
var error41 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `غلط ان پٹ: ${issue.expected} متوقع تھا، ${parsedType8(issue.input)} موصول ہوا`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error42 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Đầu vào không hợp lệ: mong đợi ${issue.expected}, nhận được ${parsedType8(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error43 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `无效输入：期望 ${issue.expected}，实际接收 ${parsedType8(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error44 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `無效的輸入值：預期為 ${issue.expected}，但收到 ${parsedType8(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error45 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Ìbáwọlé aṣìṣe: a ní láti fi ${issue.expected}, àmọ̀ a rí ${parsedType8(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
//# sourceMappingURL=zod_v4_locales.js.map
