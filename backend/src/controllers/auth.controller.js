...
export const login = async (req, res) => {
  ...
  try {
    ...
    res.json({
      ...
      role: esOwner ? 'client' : userFound.role,  // ← Owners son 'client'
      ...(esOwner && { estado: userFound.estado, cedula: userFound.cedula }), // ← Campos adicionales para clientes
...
export const forgotPassword = async (req, res) => {
  ...
  try {
    ...
    if (!user) {
      // Por seguridad, devolver mismo mensaje aunque no exista
